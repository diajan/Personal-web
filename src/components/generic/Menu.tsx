  ...
  return (
    <>
      {show ? (
        ...
        <div className='lg:block pop fixed shadow w-20 h-screen bg-blue-50 dark:bg-gray-800 z-10 rounded-r-3xl '>
          <div
            onClick={handleShow}
            className='bg-red-800 grid place-items-center w-5 h-5 absolute top-8 left-8'>
            <i className='text-white fas fa-times z-10'></i>
          </div>

          <ul className='flex flex-col h-full items-center justify-center space-y-16 xl:space-y-16 text-xl text-blue-500 dark:text-blue-50'>
            <Link href='/' passHref>
